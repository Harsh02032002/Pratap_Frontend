                                    ...
                                    {currentView === "agreements" ? (
                                       <div className="inline-flex flex-col items-center">
                                          <p className="text-xs font-bold text-slate-800">
                                             {o.checkinTermsAcceptedAt || o.checkinSubmittedAt ? new Date(o.checkinTermsAcceptedAt || o.checkinSubmittedAt).toLocaleDateString("en-IN") : "—"}
                                          </p>
                                          <span className="text-[10px] text-slate-400 font-medium">Digital Acceptance</span>
                                       </div>
                                    ) : currentView === "kyc" ? (() => {
                                       const kycVerified = (o.kyc?.status || "").toLowerCase() === "verified";
                                       const hasDoc = kycVerified || o.checkinAadhaarImage || o.checkinOwnerPhoto || o.checkinBankProof || o.checkinCancelledCheque || o.checkinAadhaarNumber || o.documentImage || o.kyc?.documentImage || o.aadharNumber;
                                       return (
                                    ...
                                    {currentView === "agreements" ? (() => {
                                       ...
                                       return (
                                          <span className={cn(
                                             ...
                                             hasSigned ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-amber-50 text-amber-600 border border-amber-100"
                                          )}>
                                             {hasSigned ? "Signed & Accepted" : "Pending Signature"}
                                          </span>
                                       );
                                    })() : (
                                       <span className={cn(
